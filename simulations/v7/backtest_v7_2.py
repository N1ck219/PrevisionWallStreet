...
def run_backtest(test_days=TEST_DAYS):
    """Esegue il backtest intraday V7.2 su barre a 5 minuti."""
    print(f"\n🚀 AVVIO BACKTEST V7.2 (PRO REAL-WORLD) — {test_days} Giorni")
    print("=" * 60)
...
def generate_report(storia_equity, tutti_trade, trade_per_ora, test_dates):
    ...
    print("\n" + "=" * 60)
    print("📊 REPORT BACKTEST V7.2 (PRO REAL-WORLD)")
    print("=" * 60)
    ...
    fig.suptitle('Backtest V7.2 — PRO Real-World', fontsize=16, fontweight='bold')
    ...
    plt.tight_layout()
    report_path = os.path.join(REPORT_DIR, "backtest_v7_2_report.png")
    ...
    if n_trade > 0:
        csv_path = os.path.join(REPORT_DIR, "trades_v7_2.csv")
